...
const tracks = [
  {
    ...
    body: "A statistician and an AI builder you can actually trust to tell you when a model is wrong. Start with a free written audit — no call, no obligation, yours to keep.",
    href: "/diagnostic",
  ...
  },
  {
    ...
    title: "Modern websites — properly engineered, owned by you.",
    body: "Fast, conversion-focused sites built on the right stack — Next.js or WordPress + Elementor. Fixed fees, no lock-in, a site you can edit yourself or have us look after. Start with a free website audit.",
    href: "/local-web",
